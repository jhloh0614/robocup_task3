...
echo_and_run cd "/home/mustar/catkin_ws/src/turtlebot_basic_packages/turtlebot_create_desktop/create_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/home/mustar/catkin_ws/src/turtlebot_basic_packages/turtlebot_create_desktop/create_dashboard/setup.py" \
     \
    build --build-base "/home/mustar/catkin_ws/build/turtlebot_basic_packages/turtlebot_create_desktop/create_dashboard" \
    install \
    --root="${DESTDIR-/}" \
