...
bool operator==(const ::turtlebot_arm_block_manipulation::PickAndPlaceGoal_<ContainerAllocator1> & lhs, const ::turtlebot_arm_block_manipulation::PickAndPlaceGoal_<ContainerAllocator2> & rhs)
{
  return lhs.frame == rhs.frame &&
    lhs.z_up == rhs.z_up &&
    lhs.gripper_open == rhs.gripper_open &&
