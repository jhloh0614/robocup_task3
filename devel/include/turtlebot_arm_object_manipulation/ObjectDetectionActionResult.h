...
bool operator==(const ::turtlebot_arm_object_manipulation::ObjectDetectionActionResult_<ContainerAllocator1> & lhs, const ::turtlebot_arm_object_manipulation::ObjectDetectionActionResult_<ContainerAllocator2> & rhs)
{
