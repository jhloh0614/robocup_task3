...
bool operator==(const ::turtlebot_arm_object_manipulation::UserCommandAction_<ContainerAllocator1> & lhs, const ::turtlebot_arm_object_manipulation::UserCommandAction_<ContainerAllocator2> & rhs)
{
