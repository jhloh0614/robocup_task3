...
bool operator==(const ::turtlebot_arm_object_manipulation::PickAndPlaceGoal_<ContainerAllocator1> & lhs, const ::turtlebot_arm_object_manipulation::PickAndPlaceGoal_<ContainerAllocator2> & rhs)
{
