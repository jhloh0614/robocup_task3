...
"""autogenerated by genpy from robot_vision_msgs/CheckForObjectsResult.msg. Do not edit."""
import codecs
import sys
...
class CheckForObjectsResult(genpy.Message):
  ...
  _type = "robot_vision_msgs/CheckForObjectsResult"
...
"""
  ...
  _slot_types = ['int16','robot_vision_msgs/BoundingBoxes']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bounding_boxes is None:
        self.bounding_boxes = robot_vision_msgs.msg.BoundingBoxes()
    else:
      self.id = 0
      self.bounding_boxes = robot_vision_msgs.msg.BoundingBoxes()
