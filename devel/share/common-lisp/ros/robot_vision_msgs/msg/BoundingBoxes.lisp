...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector robot_vision_msgs-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'robot_vision_msgs-msg:BoundingBox :initial-element (cl:make-instance 'robot_vision_msgs-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_vision_msgs-msg:<BoundingBoxes> is deprecated: use robot_vision_msgs-msg:BoundingBoxes instead.")))
...
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_vision_msgs-msg:bounding_boxes-val is deprecated.  Use robot_vision_msgs-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robot_vision_msgs-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBoxes>)))
  ...
  "robot_vision_msgs/BoundingBoxes")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBoxes)))
  "Returns string type for a message object of type 'BoundingBoxes"
  "robot_vision_msgs/BoundingBoxes")
